      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <section className="mt-16 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2rem] border border-cyan-300/20 bg-cyan-300/10 p-8 md:p-10">
            ...
            <h2 className="mt-5 text-4xl font-bold">{featured.title}</h2>
            ...
            <div className="mt-8">
              <CTAButton to={`/missions/${featured.slug}`}>
                Start Mission
              </CTAButton>
            </div>
          </div>
          ...
          <GlassCard>
            ...
            <h3 className="mt-5 text-2xl font-bold">How missions work</h3>
            <div className="mt-6 space-y-4 text-slate-300">
              <p>1. Choose a mission based on your interests.</p>
              <p>2. Visit the suggested animal or exhibit.</p>
        ...
        <section className="mt-20">
          <h2 className="text-3xl font-bold">Choose a mission</h2>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {missions.map((mission) => (
              ...
              >
                ...
                <h3 className="mt-5 text-2xl font-bold">{mission.title}</h3>
